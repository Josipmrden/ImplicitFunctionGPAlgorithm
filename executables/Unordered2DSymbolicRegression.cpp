...
#include <examples/SymbRegExercise/implicit_functions/unordered/Unordered2DImplicitEvaluation.h>
...
int main(int argc, char **argv)
{
    ...
    auto* unorderedEvaluation = new Unordered2DImplicitEvaluation(datasetFileName, frontier, state);
