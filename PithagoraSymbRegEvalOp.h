 ...
 */
class PithagoraSymbRegEvalOp : public EvaluateOp
{
public:
	...
	PithagoraSymbRegEvalOp(std::string datasetFileName);
};
//typedef boost::shared_ptr<PithagoraSymbRegEvalOp> SymbRegEvalOpP;
